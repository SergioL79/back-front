...
// AvatarUploader
//  ----------------
// Componente presentacional encargado de permitir la carga de la imagen de perfil del usuario (avatar).

// Responsabilidad:
// Configurar el componente FileInput con las restricciones necesarias para imágenes de perfil.
...
//
// @param {Object} props
// @param {Function} props.onChange - Callback que se ejecuta cuando el usuario
